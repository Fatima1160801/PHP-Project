            ...
            <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                    ...
                    <div class="dropdown pull-right" style="bottom: 40px;">
                        ...
                        <a href="<?php echo e(route('proposal.note.delete',$item->id )); ?>" id="btnOpportunityDeleteNote"
...
<button type="button" id="rejectBtn" data-toggle="modal" data-target="#ProposalApproveConfirmModal"  class="btn btn-danger  btn-sm pull-right">
    <?php echo e($labels['opportunity_reject'] ?? 'Reject'); ?>

    <div class="pull-left" style="display: none;"></div>
</button>

<button href="#"  id="cancelAcceptBtn"  class="btn btn-success  btn-sm pull-right">
    <?php echo e($labels['cancel_accept_btn_label'] ?? 'Cancel Accept'); ?>

    <div class="pull-left" style="display: none;"></div>
</button>

<button type="button" data-toggle="modal" data-target="#ProposalApproveConfirmModal" id="acceptBtn" class="btn btn-success  btn-sm pull-right">
