<?php $__env->startSection('content'); ?>
    <div class="card ">
        ...
        <div class="card-body ">
            ...
            <?php echo Form::open(['route' => 'settings.currency.update' ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formCurrencyUpdate']); ?>
            ...
            <div class="col-md-12">
                ...
                <div class="card-footer ml-auto mr-auto">
                    <div class="ml-auto mr-auto">
                        <a href="<?php echo e(route('settings.currency')); ?>" class="btn btn-default">
