<?php $__env->startSection('content'); ?>
    <div class="card ">
        ...
        <div class="card-body ">
            ...
            <?php echo Form::open(['route' => 'settings.store' ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formGeneralSettings','enctype'=>'multipart/form-data']); ?>
            ...
            <div class="col-md-12">
                <div class="card-footer ml-auto mr-auto">
                    <div class="ml-auto mr-auto">
                        <a href="<?php echo e(route('home')); ?>" class="btn btn-default btn-sm">
