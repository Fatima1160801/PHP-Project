<?php $__env->startSection('content'); ?>
    <div class="card ">
        <div class="card-header card-header-rose  card-header-icon">
            ...
            <h4 class="card-title">
                <?php echo e($labels['screen_add_IncomeRange'] ?? 'screen_add_IncomeRange'); ?>
        ...
        <div class="card-body ">
            ...
            <?php echo Form::open(['route' => 'settings.incomeRange.store'  ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formCreate']); ?>
            ...
            <div class="col-md-12">
                ...
                <div class="card-footer ml-auto mr-auto">
                    <div class="ml-auto mr-auto">
                        <a href="<?php echo e(route('settings.incomeRange.index')); ?>" class="btn btn-default btn-sm">
