        ...
        <div class="card card-wizard" data-color="rose" id="createTaskWizard">
            ...
            <div class="wizard-navigation">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#concept_tab" data-toggle="tab" role="tab">
                            <?php echo e($labels['proposal_title'] ?? 'Proposal'); ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#feedback" data-toggle="tab" role="tab">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('a[href="#log_hour"]').click(function () {
                ...
                get_fiexd_attachments(primary_id,'<?php echo e($activity_type); ?>',13,0);
        ...
        function loadConcept() {
            ...
            get_fiexd_attachments(primary_id,'<?php echo e($activity_type); ?>',0,13);
        ...
        $(document).on('click', '#approveBtn', function () {
            $("#ProposalApproveConfirmModal #approved_reject_title").text("Approve Confirm");
        ...
        $(document).on('click', '#rejectBtn', function () {
            $("#ProposalApproveConfirmModal #approved_reject_title").text("Reject Confirm");
            $("#ProposalApproveConfirmModal #approved_reject_type").val(4);
            $("#ProposalApproveConfirmModal #approved_reject_opp_id").val($("#object_primary_id").val());
        });

        $(document).on('click', '#acceptBtn', function () {
            $("#opportunityApproveConfirmModal #approved_reject_title").text("Accept Confirm");
        ...
        function drawBar($id){
            ...
            var rl = '<?php echo e(url('proposal/statusControl')); ?>' + '/' + $id;
