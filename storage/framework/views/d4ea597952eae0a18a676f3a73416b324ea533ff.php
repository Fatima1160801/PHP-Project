<?php $__env->startSection('content'); ?>
    <div class="card ">
        <div class="card-header card-header-rose  card-header-icon">
            ...
            <h4 class="card-title">
                <?php echo e($labels["add_activity_lessons_type"]??"add_activity_lessons_type"); ?>
        ...
        <div class="card-body ">
            ...
            <?php echo Form::open(["route" => "activity.lessons.type.store"  ,"novalidate"=>"novalidate","action"=>"post" ,"id"=>"formLessonsTypeCreate"]); ?>
