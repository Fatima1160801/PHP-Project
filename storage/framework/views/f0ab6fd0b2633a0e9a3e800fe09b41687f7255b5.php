            ...
            <div class="table-responsive">
                <table class="table " id="table">
                    ...
                    <tr>
                        ...
                        <th width="120">
                            <?php echo e($labels['proposal_num_title'] ?? 'Proposal No.'); ?>
                        ...
                        <th>
                            <?php echo e($labels['proposal_deadline_title'] ?? 'Deadline'); ?>
                    ...
                    <?php if(!empty($opportunity_list)): ?>
                        <?php $__currentLoopData = $opportunity_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($item->{'proposal_status_'.lang_character()} ?? ""); ?></td>
                                <td><?php echo e($item->{'staff_name_'.lang_character()} ?? ""); ?></td>

                                <td>
                                    <a href="<?php echo e(route('proposal.proposal.edit',$item->id)); ?>"
                                    ...
                                    <a href="<?php echo e(route('proposal.delete',$item->id )); ?>" id="btnOpportunityDelete"
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        $(document).on('change', '#strategic_id', function (e) {
            ...
            var url = '<?php echo e(route("proposal.proposal.index")); ?>' + '/' + strategic_id;
