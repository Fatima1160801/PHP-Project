...
<?php $__env->startSection('content'); ?>
    ...
    <div class="col-md-12 col-12 mr-auto ml-auto">
        <div class="card card-wizard" data-color="rose" id="createTaskWizard">
            ...
            <div class="card-header text-center">
                <h3 class="card-title">
                    <?php echo e($labels['proposal_title'] ?? 'Proposal'); ?>
                ...
                <ul class="nav nav-pills">
                    <li class="nav-item" id="task_link" data-task-id="">
                        <a class="nav-link active"  id="tabno1" href="#main_info" data-toggle="tab" role="tab">
                            <?php echo e($labels['concept_label'] ?? 'Information'); ?>
                    ...
                    <li class="nav-item">
                        <a class="nav-link"  id="tabno4" href="#feedback" data-toggle="tab" role="tab">
                            <?php echo e($labels['feed_back_label'] ?? 'Donor Feedback'); ?>
                    ...
                    <div class="tab-pane active" id="main_info">
                        <div id="task_main_info">
                            <?php if($page_action=="edit"): ?>
                                <?php echo Form::open(['route' => 'proposal.update' ,'action'=>'post' ,'id'=>'formOpportinunityCreate']); ?>

                            <?php else: ?>
                                <?php echo Form::open(['route' => 'proposal.store' ,'action'=>'post' ,'id'=>'formOpportinunityCreate']); ?>
                            ...
                            <div class="col-md-12 opp-progress-approve-reject" id="fill-opp-progress-approve-reject">
                                ...
                                <h6 style="text-transform: capitalize;font-weight: bold;" class="pull-left mr-5"><?php echo e($labels['opp_status_label'] ?? 'Status'); ?> : <span style="text-transform: capitalize;font-weight:normal;color:<?php echo e($opportunity->status_color); ?>;" id="title-app-rej"><?php if($page_action=="edit"): ?> <?php echo e($opportunity->statusInfo ? ($opportunity->statusInfo->{'proposal_status_'.lang_character()} ? $opportunity->statusInfo->{'proposal_status_'.lang_character()} :""):""); ?><?php else: ?> <?php endif; ?></span></h6>
                                <?php if($opportunity->proposal_status_id !=1): ?>
                               ...
                               <?php endif; ?>
                                ...
                                <div class="col-md-6 pull-right">
                                    ...
                                    <div class="pull-left col-md-8">
                                        <?php if($opportunity->opportunity_id !=0): ?>
                                            <a href="<?php echo e(route('opportunity.opportunity.edit',$opportunity->opportunity_id ?? 0)); ?>" style="font-size: 12px;color: #3F51B5;" class="pull-left col-md-6" id=""><div class="ripple-container"></div><i class="material-icons">link</i>Opportunity No : <?php echo e($opportunity->opportunity_id ?? 0); ?></a>
                                        <?php endif; ?>
                                        <?php if($opportunity->concept_id !=0): ?>
                                            <a href="<?php echo e(route('concept.concept.edit',$opportunity->concept_id ?? 0)); ?>" style="font-size: 12px;color: #3F51B5;" class="pull-left col-md-6" id=""><div class="ripple-container"></div><i class="material-icons">link</i>Concept No : <?php echo e($opportunity->concept_id ?? 0); ?></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            ...
                            <input id="fixed_status_val" type="hidden" value="<?php if($page_action=="edit"): ?> <?php echo e($opportunity->proposal_status_id ?? 1); ?><?php else: ?> 1 <?php endif; ?>" />
                            ...
                            <div class="col-md-12">
                                ...
                                <button type="button" data-toggle="modal" data-target="#ProposalApproveConfirmModal" id="approveBtn" class="btn btn-success  btn-sm pull-right">
                                    <?php echo e($labels['confirm_label'] ?? 'Confirm'); ?>
                                ...
                                <button href="#"  id="cancelApproveBtn"  class="btn btn-success  btn-sm pull-right">
                                    <?php echo e($labels['cancel_confirm_label'] ?? 'Cancel confirm'); ?>
                                ...
                                <a href="<?php echo e(route('proposal.proposal.index')); ?>" class="btn btn-sm btn-default pull-left"
                                   id="nextProjectMain2">
                             ...
                             <input type="hidden" id="proposal_file_val" value="0"/>
            ...
            <div class="card-footer">
                ...
                <a href="<?php echo e(route('proposal.proposal.index')); ?>" class="btn btn-finish btn-fill btn-rose btn-wd"
                        ...
                        <div class="col-md-12">
                            <div class="card-footer ml-auto mr-auto">
                                <div class="ml-auto mr-auto">
                                    <a data-dismiss="modal" aria-label="Close" id="modal-dismiss-f" href="#" class="btn btn-default">
            ...
            <div class="modal-content">
                <div class="card card-signup card-plain">
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo Form::open( ['route' => 'proposal.note.update','action'=>'post' ,'id'=>'formEditComment']); ?>
                        ...
                        <div class='form-group has-default bmd-form-group'>
                            ...
                            <input type="hidden" value="" id="donor_id_val" >
                        ...
                        <div class="col-md-12">
                            <div class="card-footer ml-auto mr-auto">
                                <div class="ml-auto mr-auto">
                                    <a data-dismiss="modal" aria-label="Close" id="modal-dismiss-f" href="#" data-dismiss="modal" aria-label="Close" class="close btn btn-sm btn-default">
                                        <?php echo e($labels['cancel'] ?? 'cancel'); ?>
    ...
    <div class="modal fade" id="ProposalApproveConfirmModal" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="card card-signup card-plain">
                    <div class="modal-header">
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo Form::open(['route' => 'proposal.approve.reject' ,'action'=>'post' ,'id'=>'formOppStatusChange']); ?>
                        ...
                        <div class="col-md-12">
                            ...
                            <label for="edit_note" class="col-form-label"><?php echo e(\Carbon\Carbon::now()->format('d/m/Y')); ?> , <?php echo e(\Carbon\Carbon::now()->format('H:i')); ?></label>
                        </div>
                        <div class="col-md-12">
                ...
                <div class="card card-signup card-plain">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            <div class="card-footer ml-auto mr-auto">
                                <div class="ml-auto mr-auto">
                                    <a data-dismiss="modal" aria-label="Close" id="modal-dismiss-l" href="#" class="btn btn-default">
                                        <?php echo e($labels['cancel'] ?? 'cancel'); ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            $("#expected_funder_feedback_dt").on("dp.change", function (e) {
                $('#expected_funder_feedback_dt').data("DateTimePicker").minDate(new Date());
            });
            <?php endif; ?>
            ...
            $('a[href="#log_hour"]').click(function () {
                ...
                get_fiexd_attachments(primary_id,'<?php echo e($activity_type); ?>',13,0,0);
            ...
            wizard();
            disabledTab();
            var ref_opp_id='<?php echo e($opp_id ??0); ?>';
            var ref_concept_id='<?php echo e($concept_id ??0); ?>';
            var app_st='<?php echo e($opportunity->proposal_status_id ?? 1); ?>';
            <?php if($page_action=="edit"): ?>
            fillJobTitle();
            buttonControl(app_st);
            enabledTab();
            <?php if(!empty($opportunity->opportunity_id)): ?>
            displayOppLink();
            <?php endif; ?>
            <?php if(!empty($opportunity->concept_id)): ?>
            displayReference();
            <?php endif; ?>
            ...
            setTimeout(function(){
                ...
                fillreference(ref_opp_id,ref_concept_id);
            }, 500);
            <?php endif; ?>

            <?php if($closed_concept=="closed"): ?>
            disabledAllForm();
            <?php endif; ?>
        ...
        $(document).on('submit', '#formOpportinunityCreate', function (e) {
            ...
            var valid_val =checkFunderVal();
            if(valid_val){//check funder % valu <= 100
            var valid_budg_val =ckeckBudgetCurrencyVal();
            if(valid_budg_val){//check currency if budget not empty
            e.preventDefault();
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        ...
                        buttonControl(1);
                        var editswitch='<?php echo e(route('proposal.update')); ?>';
                        ...
                        enabledTab();
                        drawBar(1);
                        $("#formOpportinunityCreate").attr("action","<?php echo e(route('proposal.update')); ?>");
                ...
                var warning_messgae='<?php echo e(getMessage('2.334')['text']); ?>';
                myNotify('warning', '', 'warning', '5000', warning_messgae);
                return false;
            }
            }else{
                var warning_messgae='<?php echo e(getMessage('2.333')['text']); ?>';
                myNotify('warning', '', 'warning', '5000', warning_messgae);
                return false;
            }
        });
        ...
        function loadComments() {
            ...
            var url = '<?php echo e(route('proposal.note.index')); ?>' + '/' + task_id;
            $.ajax({
                url: url,
                // dataTypes: 'json',
                data: '',
        ...
        function loadFeedBack() {
            ...
            //var form = $(this).serialize();
            var task_id = $('#object_primary_id').val();
            var url = '<?php echo e(route('proposal.feedback.index')); ?>' + '/' + task_id;
            $.ajax({
                url: url,
                // dataTypes: 'json',
                data: '',
                ...
                success: function (response) {
                    ...
                    $('#loader-icon-c').hide();
                    $('#feed_opp_id_input').val($('#object_primary_id').val());

                    setTimeout(function () {
                        if ($('#fixed_status_val').val() == 2) {
                            $("#rejectBtn").css("display", "block");
                            $("#acceptBtn").css("display", "block");
                            $("#cancelAcceptBtn").css("display", "none");
                        } else if ($('#fixed_status_val').val() == 3){
                            $("#rejectBtn").css("display","none");
                            $("#acceptBtn").css("display","none");
                            $("#cancelAcceptBtn").css("display","block");
                        }else if($('#fixed_status_val').val() == 4){
                            $("#FeedBackcancelRejectBtn").css("display","block");
                            $("#rejectBtn").css("display","none");
                            $("#acceptBtn").css("display","none");
                            $("#cancelAcceptBtn").css("display", "none");
                        }
        ...
        function loadConcept() {
            ...
            if($('#object_primary_id').val() !=0 && $('#object_primary_id').val()!=null && $('#object_primary_id').val() !=""){
            get_fiexd_attachments(primary_id,'<?php echo e($activity_type); ?>',0,13,1);
            enabledTab();
            }else{
            myNotify('<?php echo e($messageTabControl["icon"]); ?>', '<?php echo e($messageTabControl["title"]); ?>', '<?php echo e($messageTabControl["type"]); ?>', '5000','<?php echo e($messageTabControl["text"]); ?>');
            disabledTab();
            return false;
            }
        ...
        function loadDocuments() {
            ...
            // var task_id = $('#task_link').attr('data-task-id');
            var task_id = 1;
            var url = '<?php echo e(route('proposal.document.index')); ?>' + '/' + task_id;
            $.get(url, function (response) {
                $('#loader-icon-l').hide();
        ...
        $(document).on('submit', '#formAddNote', function (e) {
            var pro_st=$("#proposal_st_val").val();
            var feed_pro_st=$("#feed_proposal_st_val").val();
           // if(pro_st !=4 && feed_pro_st !=4) {
            if(pro_st ==1 && feed_pro_st ==1) {
            e.preventDefault();
            if (!is_valid_form($(this))) {
                return false;
            }
        ...
        $(document).on('submit', '#formFeedbackNote', function (e) {
            var pro_st=$("#proposal_st_val").val();
            var feed_pro_st=$("#feed_proposal_st_val").val();
           // var dtt=$(this).attr('data-donorid');
            //if(pro_st !=4 && feed_pro_st !=4) {
            //&& dtt !=0
            if((pro_st ==1 && feed_pro_st ==1) || (pro_st ==2)) {
            e.preventDefault();
            if (!is_valid_form($(this))) {
                return false;
            }
        ...
        $(document).on('submit', '#formEditComment', function (e) {
            ...
            var pro_st=$("#proposal_st_val").val();
            var feed_pro_st=$("#feed_proposal_st_val").val();
            var donor_id_val=$("#donor_id_val").val();
            //if(pro_st !=4 && feed_pro_st !=4) {
            //if(pro_st ==1 && feed_pro_st ==1) {
             if((pro_st ==1 && feed_pro_st ==1) || (feed_pro_st ==2 && donor_id_val !=0 )) {
                e.preventDefault();
                if (!is_valid_form($(this))) {
                    return false;
                }
                ...
                var url = $(this).attr('action');
                $.ajax({
                    url: url+"?action_type="+donor_id_val,
                    data: form,
                    type: 'post',
                    beforeSend: function () {
                        $('.loader').show();
        ...
        $(document).on('click', '#cancelAcceptBtn', function (e) {
            e.preventDefault();
            $this = $(this);
            swal({
                text: '<?php echo e(getMessage('2.304')['text']); ?>',
                confirmButtonClass: 'btn btn-success  btn-sm',
                cancelButtonClass: 'btn btn-danger  btn-sm',
                buttonsStyling: false,
                showCancelButton: true
                ...
                if (result == true) {
                    url = '<?php echo e(url("proposal/cancel/approve/reject/")); ?>'+'/'+$('#object_primary_id').val()+"?action_type=2";
                    $.ajax({
                        url: url,
                        type: 'get',
                        beforeSend: function () {
                        ...
                        success: function (data) {
                            if (data.status == true) {
                                ...
                                enabledAllForm();
                                $('#fixed_status_val').val(data.opp_status);
                                // $($this).closest('tr').css('background', 'red').delay(1000).hide(1000);
                                myNotify(data.message.icon, data.message.title, data.message.type, '5000', data.message.text);
                                $('#contentModal .close').click();
                            } else {
        ...
        $(document).on('click', '#FeedBackcancelRejectBtn', function (e) {
            e.preventDefault();
            $this = $(this);
            swal({
                text: '<?php echo e(getMessage('2.305')['text']); ?>',
                confirmButtonClass: 'btn btn-success  btn-sm',
                cancelButtonClass: 'btn btn-danger  btn-sm',
                buttonsStyling: false,
                showCancelButton: true
                ...
                if (result == true) {
                    url = '<?php echo e(url("proposal/cancel/approve/reject/")); ?>'+'/'+$('#object_primary_id').val()+"?action_type=3";
                    $.ajax({
                        url: url,
                        type: 'get',
                        beforeSend: function () {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == true) {
                        ...
                        $('#fixed_status_val').val(data.opp_status);
                        $('#ProposalApproveConfirmModal').modal('hide');
                        myNotify(data.message.icon, data.message.title, data.message.type, '5000', data.message.text);
        ...
        $(document).on('click', '#approveBtn', function () {
            $("#ProposalApproveConfirmModal #approved_reject_title").text("Confirm Proposal");
            $("#ProposalApproveConfirmModal #approved_reject_type").val(2);
            $("#ProposalApproveConfirmModal #approved_reject_opp_id").val($("#object_primary_id").val());
        ...
        $(document).on('click', '#rejectBtn', function () {
            $("#ProposalApproveConfirmModal #approved_reject_title").text("Reject Proposal");
            $("#ProposalApproveConfirmModal #approved_reject_type").val(4);
            $("#ProposalApproveConfirmModal #approved_reject_opp_id").val($("#object_primary_id").val());
        });

        $(document).on('click', '#acceptBtn', function () {
            $("#ProposalApproveConfirmModal #approved_reject_title").text("Accept Proposal");
            $("#ProposalApproveConfirmModal #approved_reject_type").val(3);//
            $("#ProposalApproveConfirmModal #approved_reject_opp_id").val($("#object_primary_id").val());
        });
        ...
        function buttonControl($status){
            ...
            if($status==3){
                ...
                $("#rejectBtn").hide();
                $("#cancelAcceptBtn").show();
                $("#acceptBtn").hide();
                $("#FeedBackcancelRejectBtn").hide();
            }else if($status==4){
                $("#approveBtn").hide();
                $("#cancelApproveBtn").hide();
                $("#cancelRejectBtn").show();
                $("#FeedBackcancelRejectBtn").show();
                $("#rejectBtn").hide();
                $("#acceptBtn").hide();
                $("#cancelAcceptBtn").hide();
            }
            else if($status==2){
                $("#approveBtn").hide();
            ...
            $("#proposal_st_val").val($status);
            $("#feed_proposal_st_val").val($status);
            //$(".opp-progress-approve-reject").css("display","block");
        }

        function drawBar($id){
            $('#fill-opp-progress-approve-reject').fadeOut();
            var proposal_id=$("#id").val();
            <?php if($page_action=="edit"): ?>
                proposal_id = '<?php echo e($opportunity->id); ?>';
            <?php endif; ?>
            var rl = '<?php echo e(url('proposal/statusControl')); ?>' + '/' + $id+'/'+proposal_id;
        ...
        $(document).on('click', '#cancelRejectBtn', function (e) {
            ...
            swal({
                ...
                if (result == true) {
                    url = '<?php echo e(url("proposal/cancel/approve/reject/")); ?>'+'/'+$('#object_primary_id').val();
                    $.ajax({
                        url: url,
                        type: 'get',
                        beforeSend: function () {
        ...
        $(document).on('click', '#cancelApproveBtn', function (e) {
            ...
            swal({
                ...
                if (result == true) {
                    url = '<?php echo e(url("proposal/cancel/approve/reject/")); ?>'+'/'+$('#object_primary_id').val()+"?action_type=1";
                    $.ajax({
                        url: url,
                        type: 'get',
                        beforeSend: function () {
        ...
        $(document).on('click', '#btnOpportunityDeleteNote', function (e) {
            ...
            var feed_pro_st=$("#feed_proposal_st_val").val();
            var dtt=$(this).attr('data-donorid');
            if((pro_st ==1 && feed_pro_st ==1) || (feed_pro_st ==2 && dtt !=0 )){
            //if(pro_st ==1 && feed_pro_st ==1) {
            //if(pro_st !=4 && feed_pro_st !=4) {
            e.preventDefault();
            $this = $(this);
        ...
        $(document).on('click', '#deleteApporBtn', function (e) {
            ...
            swal({
                ...
                if (result == true) {
                    // var project_id = $('#formProjectMain #id').val();
                    url = '<?php echo e(url("proposal/delete/")); ?>'+'/'+$('#object_primary_id').val();
                    $.ajax({
                        url: url,
                        type: 'delete',
                        beforeSend: function () {
                        ...
                        success: function (data) {
                            if (data.status == true) {
                                //  $($this).closest('tr').css('background', 'red').delay(1000).hide(1000);
                                window.location.href = "<?php echo e(url('proposal/index')); ?>";
        ...
        function disabledAllForm() {
            ...
            $("#formOpportinunityCreate input[type='text']").prop("disabled", true);
        ...
        function enabledAllForm() {
            ...
            $("#formOpportinunityCreate input[type='text']").prop("disabled", false);
            ...
            $("#formOpportinunityCreate input[type='text']").removeAttr("style");
            $("#formOpportinunityCreate textarea").removeAttr("style");
            $("#formOpportinunityCreate select").removeAttr("style");
            $("#formOpportinunityCreate div.bootstrap-select").removeAttr("style");

             /////*******************************************////
            $("#formOpportinunityCreate #opportunity_source_id").prop("disabled", true);
            $("#formOpportinunityCreate #institution_role_id").prop("disabled", true);
            $("#formOpportinunityCreate #opportunity_type_id").prop("disabled", true);
          //  $("#formOpportinunityCreate #opp_date").prop("disabled", true);
           // $("#formOpportinunityCreate #reference_number").prop("disabled", true);
            $("#formOpportinunityCreate #opportunity_subject_na").prop("disabled", true);
            $("#formOpportinunityCreate #opportunity_description_na").prop("disabled", true);
            $("#formOpportinunityCreate #concept_subject_na").prop("disabled", true);
            $("#formOpportinunityCreate #concept_description_na").prop("disabled", true);

            $("#formOpportinunityCreate #opportunity_source_id").css("background","#e9ecef");
            $("#formOpportinunityCreate #institution_role_id").css("background","#e9ecef");
            $("#formOpportinunityCreate #opportunity_type_id").css("background","#e9ecef");

            //$("#formOpportinunityCreate #opp_date").css("background","#e9ecef");
            //$("#formOpportinunityCreate #reference_number").css("background","#e9ecef");
            $("#formOpportinunityCreate #opportunity_subject_na").css("background","#e9ecef");
            $("#formOpportinunityCreate #opportunity_description_na").css("background","#e9ecef");
            $("#formOpportinunityCreate #concept_subject_na").css("background","#e9ecef");
            $("#formOpportinunityCreate #concept_description_na").css("background","#e9ecef");
        }
        ...
        function draw_members_jobs_raw(row_index,type=null)
        {
            ...
            options_members+='<option  value=""></option>';
            ...
            var options_jobs = '<td class="jobs" ><select class="selectpicker" name="jobs_'+row_index+'" id="jobs_'+row_index+'" data-style="btn btn-link" minlength="0" maxlength="10" data-live-search="true">';
            options_jobs+='<option  value=""></option>';
        ...
        function fillreference($opp_id,$concept_id){
            $("#opportunity_id").val($opp_id);
            $("#concept_id").val($concept_id);
        }

        function displayOppLink(){
            //to display $opportunity related to concept.
            var ref_link = '<?php echo e(route('opportunity.opportunity.edit',$opportunity->opportunity_id ?? 0)); ?>';
            var text="رقم الفرصة";
            var ref_subject='<?php echo e($opportunity->opp_name ?? ""); ?>';
            //+'('+ref_subject+')'
            var item=   '<a href="'+ref_link+'" class="refer_link pull-right" id="nextProjectMain2">'+
                ...
                ''+text+'</a>';
           // $("#display-opp-link").html(item)
        }


        function displayReference(){
            //to display proposal related to concept.
            var ref_link = '<?php echo e(route('concept.concept.edit',$opportunity->concept_id ?? 0)); ?>';
            var text="رقم التصور";
            var item=   '<a href="'+ref_link+'" class="refer_link pull-right" id="nextProjectMain2">'+
                '<div class="ripple-container"></div><i class="material-icons">link</i>'+
                ''+text+'</a>';
        ...
        function disabledTab() {
            // $("#tabno2").prop("disabled",true);
            $("#tabno3").prop("disabled",true);
            $("#tabno4").prop("disabled",true);
            $("#tabno5").prop("disabled",true);
        }

        function enabledTab() {
            //$("#tabno2").prop("disabled",false);
            $("#tabno3").prop("disabled",false);
            $("#tabno4").prop("disabled",false);
            $("#tabno5").prop("disabled",false);
        }
        //****************/

        $(document).on('click', '.goBack', function(){
            var prevtabno= $(this).attr("data-tabseq");
            if(prevtabno > 0){
                $("#tabno"+prevtabno).click();
            }
        });

        $(document).on('click', '.goNext', function(){
            var nexttabno= $(this).attr("data-tabseq");
            if(nexttabno > 0) {
                $("#tabno" + nexttabno).click();
            }
        });
        ...
        $('a[href="#main_info"]').click(function () {
            var stat_val=$("#fixed_status_val").val();
            if(stat_val==1){
                enabledAllForm();
                buttonControl(stat_val);
                drawBar(stat_val);
            }else{
                disabledAllForm();
                buttonControl(stat_val);
...
<?php $__env->startSection('js'); ?>
    ...
    <?php if(\Illuminate\Support\Facades\Auth::user()->lang_id ==2): ?>
        <script src="<?php echo e(asset('js/concept_edit_wizard_rtl.js')); ?>"></script>
    <?php else: ?>
        <script src="<?php echo e(asset('js/concept_edit_wizard.js')); ?>"></script>
    <?php endif; ?>
