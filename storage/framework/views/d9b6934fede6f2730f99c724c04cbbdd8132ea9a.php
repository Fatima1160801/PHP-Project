                    ...
                    <div class="col-md-12 ">
                        <div class="panel panel-default">
                            <table class="table">
                                ...
                                <tbody id="projects-list" align="center">
                                <?php if($projects): ?>
                                    <?php $__currentLoopData = $projects; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $project): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td><a href="<?php echo e(route('project.staff.edit',$project->manager_id)); ?>">
                                            ...
                                            <td>
                                                <?php if($activity->subActivity->count() > 0): ?>
                                                    <a href="<?php echo e(route('activity.subActivity.index',['main_id' => $activity->id,'is_dash' => 1])); ?>"
                                                       ...
                                                       rel="tooltip"
                                                       data-original-title="<?php echo e($labels_activity['sub_activity'] ?? 'sub_activity'); ?>"
                    ...
                    <div class="col-md-12 ">
                        <div class="panel panel-default">
                            <table class="table" id="table">
                                ...
                                <tbody>
                                <?php if($tasks): ?>
                                    <?php $__currentLoopData = $tasks->where('progress_percent','<',100); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <p class="p_task">
