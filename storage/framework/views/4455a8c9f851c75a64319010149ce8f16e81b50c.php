<?php $__env->startSection('content'); ?>
    <div class="card ">
        <div class="card-header card-header-rose  card-header-icon">
            ...
            <h4 class="card-title">
                 <?php echo e($labels['edit_city']??'edit_city'); ?>
        ...
        <div class="card-body ">
            ...
            <?php echo Form::open(['route' => 'settings.cities.update' ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formCityUpdate']); ?>
            ...
            <div class="col-md-12">
                ...
                <div class="card-footer ml-auto mr-auto">
                    <div class="ml-auto mr-auto">
                        <a href="<?php echo e(route('settings.cities')); ?>" class="btn btn-default">
                            <?php echo e($labels['back'] ?? 'back'); ?>

                        </a>
                        <button type="submit" id="btnUpdateCity" class="btn btn-next btn-rose pull-right">
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        $('#formCityUpdate').submit(function(e){
