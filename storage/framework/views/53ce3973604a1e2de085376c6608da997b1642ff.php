...
<?php echo Form::open(['route' => 'concept.feedback.note.store' ,'action'=>'post' ,'id'=>'formFeedbackNote']); ?>
            ...
            <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                    ...
                    <div class="dropdown pull-right" style="bottom: 40px;">
                        ...
                        <a href="<?php echo e(route('concept.note.delete',$item->id )); ?>" data-donorid="<?php echo e($item->donor_id ?? 1); ?>" id="btnOpportunityDeleteNote"
...
<input type="hidden" id="feed_concept_st_val" value="<?php echo e($concept_status_id ?? 1); ?>" />

<button style="display: none;" type="button" id="rejectBtn" data-toggle="modal" data-target="#opportunityApproveConfirmModal"  class="btn btn-danger  btn-sm pull-right">
...
<button style="display: none;" type="button" data-toggle="modal" data-target="#opportunityApproveConfirmModal" id="acceptBtn" class="btn btn-success  btn-sm pull-right">
...
<a style="display: none;" href="#" id="addProposalBtn" class="btn btn-primary  btn-sm pull-right">
    <?php echo e($labels['add_proposal_btn'] ?? 'Add proposal'); ?>
