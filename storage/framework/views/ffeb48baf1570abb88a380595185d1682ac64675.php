...
<?php $__env->startSection('content'); ?>
    <div class="card ">
        <div class="card-header card-header-rose card-header-text">
            ...
            <h4 class="card-title">
                <?php echo e($labels['activities_report_lessons_screen'] ?? 'activities_report_lessons_screen'); ?>

            </h4>
        </div>
        <div class="card-body ">

            <?php echo Form::open(['route' => 'activities.report.lessons.search' ,'action'=>'get' ,'id'=>'formSearch','class'=>'']); ?>
            ...
            <div class="col-md-12">
                ...
                <a href="<?php echo e(route('reports.prepare',19)); ?>" class="btn btn-danger btn-sm "
...
<?php $__env->startSection('script'); ?>
    <script>
        $(document).ready(function () {
            ...
            datetimepicker();
            active_nev_link('activities_report_lessons')
        });
        ...
        $(document).on('click', '#btnOpenModalReport', function (e) {
            ...
            // url = $(this).attr('href');
            url = '<?php echo e(route("reports.prepare")); ?>' + '/' + 19;
            $.ajax({
                url: url,
                type: 'get',
                dataTypes: 'html',
        ...
        function retriveReportData() {
            var url = '<?php echo e(route("reports.getData",19)); ?>';
            $.get(url,
                function (data) {
        ...
        $(document).on('submit', '#formSearch', function (e) {
            e.preventDefault();
            data = $(this).serialize();
            var url = '<?php echo e(route("activities.report.lessons.search")); ?>';
            $.ajax({
                url: url,
                data: data,
                type: 'get',
        ...
        $(document).on('click', '#btnReportExcel', function (e) {
            ...
            var url = '<?php echo e(route("activities.report.lessons.reportExportExcel")); ?>' + '?' + data;
        ...
        $(document).on('click', '#btnReportPdf', function (e) {
            e.preventDefault();
            var data = $('#formSearch').serialize();
            var url = '<?php echo e(route("activities.report.lessons.btnReportPDF")); ?>' + '?' + data;
            window.location.href = url;
        });


        var reports_getData = "<?php echo e(route('reports.getData',19)); ?>";
        ...
        $(document).on('change', '#project_id', function (e) {
            ...
            $url = '<?php echo e(route('activity.getActivityByProjectId')); ?>' + '/' + project_id;
            $.ajax({
                url: $url,
                dataTypes: 'json',
                type: 'get',
