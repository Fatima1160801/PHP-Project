...
<div class="col-md-6 pull-right">
    ...
    <div class="pull-left col-md-8">
        ...
        <?php endif; ?>
        <?php if($concpt_id !=0): ?>
            <a href="<?php echo e(route('concept.concept.edit',$concpt_id ?? 0)); ?>" style="font-size: 12px;color: #3F51B5;" class="pull-left col-md-6" id=""><div class="ripple-container"></div><i class="material-icons">link</i>Concept No : <?php echo e($concpt_id ?? 0); ?></a>
        <?php endif; ?>
    </div>
</div>
