<?php $__env->startSection('content'); ?>
    <div class="card ">
        <div class="card-header card-header-rose  card-header-icon">
            ...
            <h4 class="card-title">
                <?php echo e($labels['edit_activity_lessons_related']??'edit_activity_lessons_related'); ?>
        ...
        <div class="card-body ">
            ...
            <?php echo Form::open(['route' => 'activity.lessons.related.update' ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formLessonsRelatedUpdate']); ?>
            ...
            <div class="col-md-12">
                ...
                <div class="card-footer ml-auto mr-auto">
                    <div class="ml-auto mr-auto">
                        <a href="<?php echo e(route('activity.lessons.related')); ?>" class="btn btn-sm btn-default">
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        $('#formLessonsRelatedUpdate').submit(function(e){
