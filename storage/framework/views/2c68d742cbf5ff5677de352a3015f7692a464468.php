<?php $__env->startSection('content'); ?>
    ...
    <div class="card ">
        <div class="card-header card-header-rose card-header-text">
            ...
            <h4 class="card-title">
                <?php echo e($labels['screen_project_categories_edit'] ?? 'screen_project_categories_edit'); ?>

            </h4>
        </div>

        <?php echo Form::open(['route' => 'project.projectcategories.update' ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formAdd']); ?>
