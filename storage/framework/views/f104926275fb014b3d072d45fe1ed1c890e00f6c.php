<?php $__env->startSection('content'); ?>
    ...
    <div class="card ">
        <div class="card-header card-header-rose card-header-text">
            ...
            <h4 class="card-title">
                <?php echo e($labels['screen_add_donor_types']??'screen_add_donor_types'); ?>
        ...
        <?php echo Form::open(['route' => 'project.donors.types.store'  ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formAdd']); ?>
