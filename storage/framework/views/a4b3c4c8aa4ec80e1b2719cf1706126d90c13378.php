<?php $__env->startSection('content'); ?>
    <div class="card ">
        <div class="card-header card-header-rose  card-header-icon">
            ...
            <h4 class="card-title">
                 <?php echo e($labels['add_new_currency'] ?? 'add_new_currency'); ?>
        ...
        <div class="card-body ">
            ...
            <?php echo Form::open(['route' => 'settings.currency.store' ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formCurrencyCreate']); ?>
                ...
                <div class="card-footer ml-auto mr-auto">
                    <div class="ml-auto mr-auto">
                        ...
                        <button type="submit" id="btnAddCurrency" class="btn btn-next btn-rose pull-right">
                            ...
                            </div> <?php echo e($labels['save'] ?? 'save'); ?>
