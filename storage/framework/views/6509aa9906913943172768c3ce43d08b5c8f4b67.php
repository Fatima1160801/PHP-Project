...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card ">
        ...
        <div class="card-body ">
            <a href="<?php echo e(route('concept.concept.create')); ?>" class="btn btn-primary btn-sm btn-fab btn-round"
            ...
            <div class="table-responsive">
                <table class="table " id="table">
                    ...
                    <tr>
                        ...
                        <th width="120">
                            <?php echo e($labels['concept_num_title'] ?? 'opportunity No.'); ?>
                        ...
                        <th>
                            <?php echo e($labels['concept_deadline_title'] ?? 'Deadline'); ?>
                    ...
                    <?php if(!empty($opportunity_list)): ?>
                        <?php $__currentLoopData = $opportunity_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo e($item->{'concept_status_'.lang_character()} ?? ""); ?></td>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('concept.concept.edit',$item->id)); ?>"
                                    ...
                                    <a href="<?php echo e(route('concept.delete',$item->id )); ?>" id="btnOpportunityDelete"
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        $(document).on('change', '#strategic_id', function (e) {
            ...
            var url = '<?php echo e(route("concept.concept.index")); ?>' + '/' + strategic_id;
