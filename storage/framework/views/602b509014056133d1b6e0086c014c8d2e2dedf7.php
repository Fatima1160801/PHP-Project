    ...
    <ul class="nav">
      ...
      <?php if( in_array(210,$userPermissions) || in_array(79,$userPermissions) || Auth::user()->id == 1): ?>
        <li class="nav-item " id="idGoalsSidebar">
          ...
          <div
              class="collapse   <?php if(Request::segment(1) =='strategic' || Request::segment(1) =='goals' || request()->is('goals/indicators*') || request()->is('goals/sub/*') ): ?> show <?php endif; ?> "
              id="GoalsSidebar">
            <ul class="nav">
              <li class="nav-item" id="id_goals_list">
                ...
                <div
                    class="collapse    <?php if(Request::segment(1) =='strategic' || Request::segment(1) =='goals'): ?> show <?php endif; ?>"
                    id="goals_list">
                  <ul class="nav">

                    <?php if(in_array(210,$userPermissions) || Auth::user()->id == 1): ?>
                      <li class="nav-item  <?php if(Request::segment(1) =='strategic'): ?> active <?php endif; ?>"
                          id="strategic_index">
      ...
      in_array(42,$userPermissions)    || in_array(232,$userPermissions)    || in_array(152,$userPermissions)    ||
         ...
         || in_array(241,$userPermissions) || in_array(257,$userPermissions) || in_array(249,$userPermissions)
         ): ?>
        <li class="nav-item " id="idProjectSidebar">
          ...
          <div class="collapse
            ...
            <ul class="nav">
              ...
              <?php if(in_array(241,$userPermissions) || Auth::user()->id == 1): ?>
                <li class="nav-item <?php if(request()->is('opportunity/index')||request()->is('opportunity/create')|| request()->is('opportunity/*/edit')): ?> active <?php endif; ?>"
                    id="project-index">
                  <a class="nav-link" id="" href="<?php echo e(route('opportunity.opportunity.index')); ?>">
                    <i class="material-icons">desktop_windows</i>
                    <span class="sidebar-normal">
                                               <?php echo e($labels['opportunity_menu'] ?? 'Opportunity'); ?>
              ...
              <?php if(in_array(257,$userPermissions) || Auth::user()->id == 1): ?>
                <li class="nav-item <?php if(request()->is('concept/index')||request()->is('concept/create')|| request()->is('concept/*/edit')): ?> active <?php endif; ?>"
                    id="project-index">
                  <a class="nav-link" id="" href="<?php echo e(route('concept.concept.index')); ?>">
                    <i class="material-icons">desktop_windows</i>
                    <span class="sidebar-normal">
                                   <?php echo e($labels['concept_menu'] ?? 'Concept'); ?>
              ...
              <?php if(in_array(249,$userPermissions) || Auth::user()->id == 1): ?>
                <li class="nav-item <?php if(request()->is('proposal/index')||request()->is('proposal/create')|| request()->is('proposal/*/edit')): ?> active <?php endif; ?>"
                    id="project-index">
                  <a class="nav-link" id="" href="<?php echo e(route('proposal.proposal.index')); ?>">
                    <i class="material-icons">desktop_windows</i>
                    <span class="sidebar-normal">
                                           <?php echo e($labels['proposal_menu'] ?? 'Proposal'); ?>
                      ...
                      <?php if( Auth::user()->id == 1 || in_array(225,$userPermissions) || in_array(226,$userPermissions)
                        ...
                        <li class="nav-item " id="id_reportBeneficiary">
                          ...
                          <div class="collapse <?php if(request()->is('beneficiary/report/project/index')
                                                                              || request()->is('beneficiary/famindv/report')
                                                                              || request()->is('beneficiary/organization/report') ): ?>  show <?php endif; ?>"
                               id="reportBeneficiary">
                            <ul class="nav">

                              <?php if( Auth::user()->id == 1 || in_array(227,$userPermissions)): ?>
                                <li class="nav-item <?php if(request()->is('beneficiary/report/project/index')): ?> active <?php endif; ?>"
                                    id="beneficiary_project">
                                  <a class="nav-link"
                              ...
                              <?php if( Auth::user()->id == 1 || in_array(225,$userPermissions)): ?>
                                <li class="nav-item  <?php if(request()->is('beneficiary/famindv/report')): ?> active <?php endif; ?> "
                  ...
                  <div class="collapse <?php if(request()->is('beneficiary/fam_indev*')
                    ...
                    <ul class="nav">
                      ...
                      <?php if(in_array(69,$userPermissions) || Auth::user()->id == 1): ?>
                        <li class="nav-item  <?php if(request()->is('beneficiary/fam_indev*')): ?> active <?php endif; ?>"
                            id="families_individuals">
                      ...
                      <?php if(in_array(75,$userPermissions) || Auth::user()->id == 1): ?>
                        <li class="nav-item   <?php if(request()->is('beneficiary/oraganizations*')): ?> active <?php endif; ?>"
                            id="organizations">
                          <a class="nav-link"
                      ...
                      <?php if(in_array(202,$userPermissions) || Auth::user()->id == 1): ?>
                        <li class="nav-item <?php if(request()->is('locality*')): ?> active <?php endif; ?>"
                            id="Localities-link">
              ...
              <?php if(in_array(175,$userPermissions) || in_array(217,$userPermissions) || in_array(160,$userPermissions )  ||
                ...
                <li class="nav-item " id="id_other_setting">
                  ...
                  <div class="collapse <?php if(request()->is('settings/issues/related*')
                                            ...
                                            || request()->is('settings/email/*')
                                            || request()->is('settings/visit/type/*')
                                            || request()->is('goals/indicators/measure/units/index*')  ): ?>  show <?php endif; ?>"
                       id="other_setting">
                    <ul class="nav">
                      <?php if(in_array(175,$userPermissions) || Auth::user()->id == 1): ?>
                        <li class="nav-item <?php if(request()->is('settings/issues/related*')): ?> active <?php endif; ?>"
                      ...
                      <?php if(in_array(217,$userPermissions) || Auth::user()->id == 1): ?>
                        <li class="nav-item  <?php if(request()->is('settings/issues/type*')): ?> active <?php endif; ?>"
                      ...
                      <?php if(in_array(160,$userPermissions) || Auth::user()->id == 1): ?>
                        <li class="nav-item  <?php if(request()->is('settings/currency*')): ?> active <?php endif; ?>"
                            id="currency-link">
                      ...
                      <?php if(in_array(140,$userPermissions)|| Auth::user()->id == 1): ?>
                        <li class="nav-item  <?php if(request()->is('settings/incomeRange*')): ?> active <?php endif; ?>"
                            id="incomeRange-link">
                          <a class="nav-link"
                      ...
                      <?php if(in_array(156,$userPermissions) || Auth::user()->id == 1): ?>
                        <li class="nav-item   <?php if(request()->is('settings/attachment_types*')): ?> active <?php endif; ?>"
                      ...
                      <?php if(in_array(90,$userPermissions) || Auth::user()->id == 1): ?>
                        <li class="nav-item  <?php if(request()->is('goals/indicators/measure/units/index*')): ?> active <?php endif; ?>"
                      ...
                      <?php if(in_array(90,$userPermissions) || Auth::user()->id == 1): ?>
                        <li class="nav-item  <?php if(request()->is('/labelsSettings*')): ?> active <?php endif; ?>"
                            id="labelsSettings">
                          <a class="nav-link"
                             href="<?php echo e(route('labelsSettings.index')); ?>">
                            <i class="material-icons">add</i>
                            <span class="sidebar-normal">
                                                            <?php echo e($labels['Label_Settings'] ?? 'Label Settings'); ?>
                      ...
                      <?php if(in_array(124,$userPermissions) || Auth::user()->id == 1): ?>
                        <li class="nav-item  <?php if(request()->is('/settings/email/*')): ?> active <?php endif; ?>"
                            id="EmailSettings">
                          <a class="nav-link"
                             href="<?php echo e(route('settings.email.index')); ?>">
                            <i class="material-icons">add</i>
                            <span class="sidebar-normal">
                                                            <?php echo e($labels['Email_Settings'] ?? 'Email Settings'); ?>
                      ...
                      <?php if(in_array(90,$userPermissions) || Auth::user()->id == 1): ?>
                        <li class="nav-item  <?php if(request()->is('documents/settings*')): ?> active <?php endif; ?>"
                            id="DocumentSettings">
                          <a class="nav-link"
                             href="<?php echo e(route('settings.documents.index')); ?>">
                            <i class="material-icons">add</i>
                            <span class="sidebar-normal">
                                                            <?php echo e($labels['doc_settings'] ?? 'Document Settings'); ?>
                      ...
                      <li class="nav-item <?php if(request()->is('settings/achievement/type*')): ?> active <?php endif; ?>"
                          id="achievementtypeSettings">
                        <a class="nav-link" href="<?php echo e(route('settings.achievement.type')); ?>">
                          <i class="material-icons">add</i>
                          <span class="sidebar-normal">
                                                       <?php echo e($labels['achievement_type'] ?? 'achievement_type'); ?>
                      ...
                      <li class="nav-item <?php if(request()->is('settings/visit/type/*')): ?> active <?php endif; ?>"
                          id="visittypeSettings">
                        <a class="nav-link" href="<?php echo e(url('settings/visit/type/index')); ?>">
                          <i class="material-icons">add</i>
                          <span class="sidebar-normal">
                                   <?php echo e($labels['visit_type'] ?? 'visit_type'); ?>
                  ...
                  <div class="collapse <?php if(request()->is('attachments*')
                    ...
                    <ul class="nav">
                      <?php if(in_array(115,$userPermissions) || Auth::user()->id == 1): ?>
                        <li class="nav-item <?php if(request()->is('attachments*')): ?> active <?php endif; ?>"
                            id="files_management">
                      ...
                      <?php if(in_array(5,$userPermissions) || Auth::user()->id == 1): ?>
                        <li class="nav-item  <?php if(request()->is('permission/user/index*')): ?> active <?php endif; ?>"
                            id="user">
                          <a class="nav-link"
                      ...
                      <?php if(in_array(8,$userPermissions) || Auth::user()->id == 1): ?>
                        <li class="nav-item  <?php if(request()->is('permission/group*')): ?> active <?php endif; ?>"
                            id="group">
                          <a class="nav-link"
                      ...
                      <?php if(in_array(233,$userPermissions) || Auth::user()->id == 1): ?>
                        <li class="nav-item  <?php if(request()->is('settings/general*')): ?> active <?php endif; ?>"
                            id="settings">
                      ...
                      <?php if(in_array(119,$userPermissions) || Auth::user()->id == 1): ?>
                        <li class="nav-item  <?php if(request()->is('settings/notifications*')): ?> active <?php endif; ?>"
