        ...
        <div class="card card-wizard" data-color="rose" id="createTaskWizard">
            ...
            <div class="wizard-navigation">
                <ul class="nav nav-pills">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="tabno2" href="#comments" data-toggle="tab" role="tab">
                            <?php echo e($labels['notes_label'] ?? 'Notes'); ?>

                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="tabno3" href="#log_hour" data-toggle="tab" role="tab">
                        ...
                        <div id="task_main_info">
                            ...
                            <div class="col-md-12 opp-progress-approve-reject" id="fill-opp-progress-approve-reject">
                                <div class="col-md-6 pull-left">
                                    ...
                                    <?php if($opportunity->opportunity_status_id !=1): ?>
                            ...
                            <div class="col-md-12">
                                ...
                                <button href="#"  id="cancelApproveBtn"  class="btn btn-success  btn-sm pull-right">
                                    <?php echo e($labels['opportunity_cancel_approve'] ?? 'Cancel approval'); ?>
            ...
            <div class="card-footer">
                ...
                <a href="<?php echo e(route('opportunity.opportunity.index')); ?>" class="btn btn-finish btn-fill btn-rose btn-wd"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('a[href="#log_hour"]').click(function () {
             //$('a[href="#attachments"]').click(function () {
                ...
                get_fiexd_attachments(primary_id,'<?php echo e($activity_type); ?>',0,0,0);
     ...
     /////////////////////////////////////////////////
        ...
        $(document).on('submit', '#formOppStatusChange', function (e) {
            ...
            var form = $(this).serialize();
            var url = $(this).attr('action');
            //var action_type=$("#approved_reject_type").val();
            $.ajax({
                url: url,
                data: form,
                type: 'post',
        ...
        function drawBar($id){
            ...
            var opp_id=$("#id").val();
            <?php if($page_action=="edit"): ?>
                opp_id = '<?php echo e($opportunity->id); ?>';
            <?php endif; ?>
            var rl = '<?php echo e(url('statusControl')); ?>' + '/' + $id+'/'+opp_id;
    ...
    function setPicker($id,$val) {
        ...
        $(document).on('click', '#cancelRejectBtn', function (e) {
            ...
            swal({
                ...
                if (result == true) {
                    url = '<?php echo e(url("opportunity/cancel/approve/reject/")); ?>'+'/'+$('#object_primary_id').val()+"?action_type=2";
                    $.ajax({
                        url: url,
                        type: 'get',
                        beforeSend: function () {
        ...
        $(document).on('click', '#cancelApproveBtn', function (e) {
            ...
            swal({
                ...
                if (result == true) {
                    url = '<?php echo e(url("opportunity/cancel/approve/reject/")); ?>'+'/'+$('#object_primary_id').val()+"?action_type=1";
                    $.ajax({
                        url: url,
                        type: 'get',
                        beforeSend: function () {
        ...
        function disabledAllForm() {
            ...
            $("#formOpportinunityCreate input[type='number']").prop("disabled", true);
        ...
        function enabledAllForm() {
           ...
           // $("#formOpportinunityCreate input").css("background-image", " none !important");
        ...
        $(document).on('click', '#addConceptLink', function (e) {
            ...
            var propUrl="<?php echo e(route('concept.concept.create')); ?>"+"?opp_id="+p_id;
            window.location.href = propUrl;
        });
        ...
        function displayReference(){
            ...
            var ref_subject='<?php echo e($ref_data->id ?? ""); ?>';
