...
<button type="submit" id="saveNotebtn" class="btn btn-primary  btn-md pull-right mb-5">
        ...
        <?php $__currentLoopData = $note_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <li class="timeline-inverted">
                ...
                <div class="timeline-panel">
                    ...
                    <h6 class="pull-right">
                        <i class="fa fa-clock-o"></i> <?php echo e(time_elapsed_string($item->created_at) ?? ""); ?>
...
<a style="display: none;" href="<?php echo e(route('proposal.proposal.create')); ?>" id="addProposalBtn" class="btn btn-primary  btn-sm pull-right">
