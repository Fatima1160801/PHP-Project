...
<div class="row">
                    ...
                    <select required class='form-control selectpicker list-of-types' data-live-search="true" name='attachment_type_id' id='attachment_type_id'
                        ...
                        <?php if($attachment_types): ?>
                            <?php $__currentLoopData = $attachment_types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option  <?php if($attachment->attachment_type_id==$key): ?> selected <?php endif; ?> value="<?php echo e($key); ?>"><?php echo e($c); ?></option>
    ...
    <div class='col-md-12'>
        <div class='row'>
            ...
            <div class=' col-md-8'>
                <div class='form-group has-default bmd-form-group'>
                    <input  class='form-control' id='title' name='title' type='text' value="<?php echo e($attachment->file_title ?? ""); ?>" >
                </div>
            </div>
        </div>
    </div>
    ...
    <div class='col-md-12'>
        <div class='row'>
            ...
            <div class=' col-md-8'>
                <div class='form-group has-default bmd-form-group'>
                    <input  class='form-control' id='desc' name='desc' type='text' value="<?php echo e($attachment->file_desc ?? ""); ?>" >
                </div>
            </div>
        </div>
    </div>
