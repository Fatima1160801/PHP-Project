        ...
        <div class="modal-header">
            <div class="card-header  text-center" style=" width: 100%; " align="center">
                ...
                <h4 class="card-title "  style="width: 100%; text-align: center">
                    ...
                    <?php echo e($labels['add'] ?? 'add'); ?> <?php echo e(' '.$screen_name); ?>

                </h4>
            </div>
        </div>
        <div class="modal-body">
            <?php echo Form::open(['route' => 'project.results.chain.storeSpecific' ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formStoreSpecific']); ?>
