<?php $__env->startSection('content'); ?>
    <div class="card ">
        <div class="card-header card-header-rose  card-header-icon">
            ...
            <h4 class="card-title">
                <?php echo e($labels['addOpportunitySource'] ?? 'Add Opportunity Source'); ?>
        ...
        <div class="card-body ">
            ...
            <?php echo Form::open(['route' => 'oppsources.store' ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formOpportunityCreate']); ?>
            ...
            <div class="col-md-12">
                ...
                <div class="card-footer ml-auto mr-auto">
                    <div class="ml-auto mr-auto">
                        <a href="<?php echo e(route('oppsources.index')); ?>" class="btn btn-default btn-sm">
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        $(document).on('submit', '#formOpportunityCreate', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                   ...
                   $('#btnAddOpportunity').attr("disabled", false);
                    ...
                    $("#formOpportunityCreate").trigger("reset");
                    setTimeout(() => {
                        window.location.href = '<?php echo e(route('oppsources.index')); ?>';
                        }, 1000);
