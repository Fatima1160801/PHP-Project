<?php $__env->startSection('content'); ?>
    <div class="card ">
        <div class="card-header card-header-rose  card-header-icon">
            ...
            <h4 class="card-title">
                <?php echo e($labels['addDocSetting'] ?? 'add Setting Documnent'); ?>
        ...
        <div class="card-body ">
            ...
            <?php echo Form::open(['route' => 'settings.documents.store' ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formDocumentCreate']); ?>
