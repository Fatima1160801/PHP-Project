                    ...
                    <?php if(!empty($opportunity_list)): ?>
                        <?php $__currentLoopData = $opportunity_list; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td  style="width:30% !important;" ><?php echo e($item->{'subject_'.lang_character()}); ?></td>
                                ...
                                <td>
                                    ...
                                    <a href="<?php echo e(route('concept.concept.create').'?opp_id='.$item->id); ?>"
                                       class="btn btn-sm btn-primary btn-round btn-fab"
                                       data-toggle="tooltip" data-placement="top" title="<?php echo e($labels['add_concept'] ?? 'add concept'); ?>">
                                        <i class="material-icons">add</i>
                                    </a>
