...
<?php $__env->startSection('content'); ?>
    <div class="card ">
        <div class="card-header card-header-rose card-header-text">
            ...
            <h4 class="card-title">
                <?php echo e($labels['screen_report_beneficiary_orgnaizayion'] ?? 'screen_report_beneficiary_orgnaizayion'); ?>
        ...
        <div class="card-body ">
            ...
            <?php echo Form::open(['route' => 'beneficiary.organization.report.search' ,'action'=>'get' ,'id'=>'formSearch','class'=>'']); ?>
            ...
            <div class="col-md-12">
                ...
                <a href="<?php echo e(route('reports.prepare',6)); ?>" class="btn btn-danger btn-sm "
                ...
                <a href="<?php echo e(route('beneficiary.organization.report.btnReportPDF')); ?>"  class="btn btn-sm btn-primary"
                   target="_blank" id="btnReportPdf" data-toggle="tooltip" data-placement="top" title="Export PDF">
                    <i class="material-icons" >print</i> PDF
                </a>
                <a href="<?php echo e(route('beneficiary.organization.report.reportExportExcel')); ?>" class="btn btn-sm btn-info"
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        $(document).on('click', '#btnOpenModalReport', function (e) {
            ...
            // url = $(this).attr('href');
            url = '<?php echo e(route("reports.prepare")); ?>' + '/' + 6;
            $.ajax({
                url: url,
                type: 'get',
                dataTypes: 'html',
        ...
        function retriveReportData() {
            var url = '<?php echo e(route("reports.getData",6)); ?>';
            $.get(url,
                function (data) {
        ...
        $(document).on('submit', '#formSearch', function (e) {
            e.preventDefault();
            data = $(this).serialize();
            var url = '<?php echo e(route("beneficiary.organization.report.search")); ?>';
            $.ajax({
                url: url,
                data: data,
                type: 'get',
        ...
        $(document).on('click', '#btnReportExcel', function (e) {
            ...
            var url = '<?php echo e(route("beneficiary.organization.report.reportExportExcel")); ?>'+'?'+data;
        ...
        $(document).on('click', '#btnReportPdf', function (e) {
            e.preventDefault();
            data = $('#formSearch').serialize();
            var url = '<?php echo e(route("beneficiary.organization.report.btnReportPDF")); ?>'+'?'+data;
            window.location.href = url;

        });


        var reports_getData = "<?php echo e(route('reports.getData',6)); ?>";
