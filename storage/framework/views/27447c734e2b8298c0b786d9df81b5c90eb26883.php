<?php $__env->startSection('content'); ?>
    <div class="card ">
        <div class="card-header card-header-rose  card-header-icon">
            ...
            <h4 class="card-title">
                <?php echo e($labels['editOppStatus'] ?? 'edit Opportunity Status'); ?>
        ...
        <div class="card-body ">
            ...
            <?php echo Form::open(['route' => 'optstatuses.update' ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formOppStatusUpdate']); ?>
