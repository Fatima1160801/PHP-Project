    ...
    <script>
        $(document).ready(function () {
            ...
            $('a[href="#log_hour"]').click(function () {
                 ...
                 get_fiexd_attachments(primary_id,'<?php echo e($activity_type); ?>',12,0);
        ...
        function loadConcept() {
            ...
            get_fiexd_attachments(primary_id,'<?php echo e($activity_type); ?>',0,12);
     ...
     /////////////////////////////////////////////////
        ...
        $(document).on('click', '#approveBtn', function () {
            $("#opportunityApproveConfirmModal #approved_reject_title").text("Approve Confirm");
        ...
        $(document).on('click', '#rejectBtn', function () {
            $("#opportunityApproveConfirmModal #approved_reject_title").text("Reject Confirm");
