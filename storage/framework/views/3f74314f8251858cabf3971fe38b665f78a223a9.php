<?php $__env->startSection('content'); ?>
    ...
    <div class="card ">
        <div class="card-header card-header-rose card-header-text">
            ...
            <h4 class="card-title">
                <?php echo e($labels['screen_job_title_dit'] ?? 'screen_job_title_dit'); ?>

            </h4>

        </div>

        <?php echo Form::open(['route' => 'project.jobtitle.update'  ,'novalidate'=>'novalidate','method'=>'PUT' ,'id'=>'formAdd']); ?>
        ...
        <div class="card-footer ml-auto mr-auto">
            <div class="ml-auto mr-auto">
                <a href="<?php echo e(route('project.jobtitle.index')); ?>"class="btn btn-sm btn-default pull-left">
