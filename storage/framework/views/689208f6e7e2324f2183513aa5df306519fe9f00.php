...
<script>
    ...
    function get_fiexd_attachments(primary_id, interface_id, attachment_type_not_show, attachment_type_show) {
        var url = '<?php echo e(route("attachments.fixed.index")); ?>' + '/' + primary_id + '/' + interface_id;
        $.ajax({
            url: url,
            type: 'get',
            data: {'attachment_type_not_show': attachment_type_not_show, 'attachment_type_show': attachment_type_show},
            beforeSend: function () {
                $('.loader-div').show();
