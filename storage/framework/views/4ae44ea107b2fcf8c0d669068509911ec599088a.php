<?php $__env->startSection('content'); ?>
    <div class="card ">
        <div class="card-header card-header-rose  card-header-icon">
            ...
            <h4 class="card-title">
                <?php echo e($labels['editVisit'] ?? 'editVisit'); ?>
        ...
        <div class="card-body ">
            ...
            <?php echo Form::open(['route' => 'visits.update' ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formVisitUpdate']); ?>
    ...
    <div class="col-md-12">
        ...
        <div class="card-footer ml-auto mr-auto">
            <div class="ml-auto mr-auto">
                ...
                <button btn="btnToggleDisabled" type="submit" id="btnEditVisit"
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        $(document).on('submit', '#formVisitUpdate', function (e) {
            ...
            $.ajax({
                ...
                contentType: false,
                beforeSend: function () {
                    $('#btnEditVisit').attr("disabled", true);
                    $('.loader').show();
                },
                success: function (data) {
                    $('#btnEditVisit').attr("disabled", false);
                    $('.loader').hide();
                    if (data.status == 'true') {
        ...
        $(document).on('change', '#formVisitUpdate #city_id', function (e) {
            e.preventDefault();
        ...
        $(document).on('change', '#formVisitUpdate #destrict_id', function (e) {
            e.preventDefault();
