<?php $__env->startSection('content'); ?>
    ...
    <div class="card ">
        <div class="card-header card-header-rose card-header-text">
            ...
            <h4 class="card-title">
                <?php echo e($labels['screen_job_title_add'] ?? 'screen_job_title_add'); ?>
        ...
        <?php echo Form::open(['route' => 'project.jobtitle.store' ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formAdd']); ?>
