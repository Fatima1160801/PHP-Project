<?php $__env->startSection('content'); ?>
    <div class="card ">
        <div class="card-header card-header-rose  card-header-icon">
            ...
            <h4 class="card-title">
                <?php echo e($labels['screen_add_Districts'] ?? 'screen_add_locating'); ?>
        ...
        <div class="card-body ">
            ...
            <?php echo Form::open(['route' => 'settings.districts.store' ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formDistrictCreate']); ?>
            ...
            <div class="col-md-12">
                ...
                <div class="card-footer ml-auto mr-auto">
                    <div class="ml-auto mr-auto">
                        <a href="<?php echo e(route('settings.districts')); ?>" class="btn btn-sm btn-default">
