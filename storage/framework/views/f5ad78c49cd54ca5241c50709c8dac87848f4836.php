<?php $__env->startSection('content'); ?>
    <div class="card ">
        <div class="card-header card-header-rose  card-header-icon">
            ...
            <h4 class="card-title">
                <?php echo e($labels['add_activity_lessons_related']??'add_activity_lessons_related'); ?>
        ...
        <div class="card-body ">
            ...
            <?php echo Form::open(['route' => 'activity.lessons.related.store'  ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formLessonsRelatedCreate']); ?>
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        $('#formLessonsRelatedCreate').submit(function(e){
