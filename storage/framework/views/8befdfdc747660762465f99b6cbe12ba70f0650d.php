                ...
                <div class="tab-pane active" id="user_info">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                    <?php echo Form::text('user_full_name',$user->user_full_name ,['class'=>'form-control','placeholder'=>'  ','required'=>'true']); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                    <?php echo Form::text('job_title',$user->job_title ,['class'=>'form-control','placeholder'=>'  ','required'=>'true']); ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <div class="form-group">
                                    <?php echo Form::email('email', $user->email ,['class'=>'form-control','placeholder'=>'  ','required'=>'true','email'=>'true']); ?>
