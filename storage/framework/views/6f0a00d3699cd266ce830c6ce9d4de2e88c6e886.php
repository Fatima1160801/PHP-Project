    ...
    <div class="modal-dialog modal-signup" role="document">
        <div class="modal-content">
            <div class="card card-signup card-plain">
                ...
                <div class="modal-body">
                    <?php echo Form::open(['route' => 'dashboard.projects.filter' ,'action'=>'post' ,'id'=>'formDashboardProjectsFilter']); ?>
    ...
    <div class="modal-dialog modal-signup" role="document">
        <div class="modal-content">
            <div class="card card-signup card-plain">
                ...
                <div class="modal-body">
                    <?php echo Form::open(['route' => 'dashboard.activities.filter' ,'action'=>'post' ,'id'=>'formDashboardActivitiesFilter']); ?>
