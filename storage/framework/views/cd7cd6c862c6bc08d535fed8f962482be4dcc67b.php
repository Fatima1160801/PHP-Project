<?php $__env->startSection('content'); ?>
    <div class="card ">
        <div class="card-header card-header-rose  card-header-icon">
            ...
            <h4 class="card-title">
                <?php echo e($labels['editInterface'] ?? 'edit Interface'); ?>
        ...
        <div class="card-body ">
            ...
            <?php echo Form::open(['route' => 'interfaces.update' ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formInterfaceUpdate']); ?>
    ...
    <div class="col-md-12">
        ...
        <div class="card-footer ml-auto mr-auto">
            <div class="ml-auto mr-auto">
                <a href="<?php echo e(route('interfaces.index')); ?>" class="btn btn-default btn-sm">
...
<?php $__env->startSection('script'); ?>
    <script>
        ...
        $(document).on('submit', '#formInterfaceUpdate', function (e) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == 'true') {
                        ...
                        $('.loader').hide();
                    setTimeout(() => {
                        window.location.href = "<?php echo e(route('interfaces.index')); ?>";
                        }, 1000);
