<?php $__env->startSection('content'); ?>
    <div class="card ">
            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <?php echo Form::text('user_name', $user->user_name ,['class'=>'form-control','placeholder'=>'  ']); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <?php echo Form::text('user_full_name', $user->user_full_name ,['class'=>'form-control','placeholder'=>'  ']); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <?php echo Form::text('email', $user->email ,['class'=>'form-control','placeholder'=>'  ']); ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-7">
                            <div class="form-group">
                                <?php echo Form::text('job_title', $user->job_title ,['class'=>'form-control','placeholder'=>'  ']); ?>
                        ...
                        <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                            <div class="fileinput-new thumbnail img-circle">
                                <?php if($user->user_photo): ?>
                                    <img src="<?php echo e(asset('images/user/photo/').'/'.$user->user_photo); ?>" alt="...">
                                <?php else: ?>
        ...
        <div class="card-footer text-right">
            <?php echo Form::submit('Save',['class'=>'btn btn-fill btn-rose' ,'id'=>'formAddSubmit']); ?>
