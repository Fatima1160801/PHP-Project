<div class="modal-content ">
    <div class="card  card-plain">
        <div class="modal-header">
            <div class="card-header  text-center" style=" width: 100%; " align="center">
                ...
                <h4 class="card-title "  style="width: 100%; text-align: center">
                    <?php echo e($labels['project_level_I_add_indicator'] ?? 'project_level_I_add_indicator'); ?><?php echo e(' '.$screen_name); ?>
        ...
        <div class="modal-body">
            <?php echo Form::open(['route' => 'project.results.chain.LevelIStoreIndicator' ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formLevelStoreIndicator']); ?>
