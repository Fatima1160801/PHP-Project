...
<head>
    ...
    <!-- CSS Files -->
    <link href="<?php echo e(asset('assets/css/material-dashboard.css?v=2.0.2')); ?>" rel="stylesheet" />
...
<div class="wrapper wrapper-full-page">
    <div class="page-header register-page header-filter" filter-color="black" style="background-image: url('<?php echo e(asset('assets/img/login.jpg')); ?>')">
        <div class="container">
            <div class="row">
                <div class="col-md-10 ml-auto mr-auto">
                    <div class="card card-signup">
                        <h4 class="card-title text-center">
                            ...
                            <a href="<?php echo e(url(request()->headers->get('referer'))); ?>" class="btn btn-rose mt-5">
                                <i class="material-icons">settings_backup_restore</i> Back
                            </a>

                            <a href="<?php echo e(url('login')); ?>" class="btn btn-rose mt-5">
