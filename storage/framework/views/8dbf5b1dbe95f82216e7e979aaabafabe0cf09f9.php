                                ...
                                <li class="nav-item " id="id_other_setting">
                                    ...
                                    <div class="collapse <?php if(request()->is('settings/issues/related*')
                                        ...
                                        <ul class="nav">
                                            ...
                                            <?php endif; ?>
                                                <?php if(in_array(90,$userPermissions) || Auth::user()->id == 1): ?>
                                                    <li class="nav-item  <?php if(request()->is('/optstatuses*')): ?> active <?php endif; ?>" id="optstatuses">
                                                        <a class="nav-link"
                                                           href="<?php echo e(route('optstatuses.index')); ?>">
                                                            <i class="material-icons">add</i>
                                                            <span class="sidebar-normal">
                                                          <?php echo e($labels['addOppStatus'] ?? 'Opportunity Status'); ?>
                                                ...
                                                <?php if(in_array(90,$userPermissions) || Auth::user()->id == 1): ?>
                                                    <li class="nav-item  <?php if(request()->is('/oppsources*')): ?> active <?php endif; ?>" id="oppsources">
                                                        <a class="nav-link"
                                                           href="<?php echo e(route('oppsources.index')); ?>">
                                                            <i class="material-icons">add</i>
                                                            <span class="sidebar-normal">
                                                           <?php echo e($labels['addOpportunitySource'] ?? 'Opportunity Source'); ?>
                                                ...
                                                <?php if(in_array(90,$userPermissions) || Auth::user()->id == 1): ?>
                                                    <li class="nav-item  <?php if(request()->is('/interfaces*')): ?> active <?php endif; ?>" id="interfaces">
                                                        <a class="nav-link"
                                                           href="<?php echo e(route('interfaces.index')); ?>">
                                                            <i class="material-icons">add</i>
                                                            <span class="sidebar-normal">
                                                            <?php echo e($labels['addInterface'] ?? 'Add Interface'); ?>
