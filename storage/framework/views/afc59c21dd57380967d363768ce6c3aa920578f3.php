...
<?php echo Form::open(['route' => 'proposal.note.store' ,'action'=>'post' ,'id'=>'formAddNote']); ?>
...
<div class="clearfix"></div>
        <ul class="timeline timeline-simple">
                    ...
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="dropdown pull-right" style="bottom: 40px;">
                                <button type="button" data-toggle="modal"  data-donorid="<?php echo e($item->donor_id ?? 1); ?>" data-target="#opportunityNoteModal" data-noteid="<?php echo e($item->id); ?>" data-note="<?php echo e($item->note); ?>"
         ...
         <input type="hidden" id="proposal_st_val" value="<?php echo e($proposal_status_id ?? 1); ?>" />
