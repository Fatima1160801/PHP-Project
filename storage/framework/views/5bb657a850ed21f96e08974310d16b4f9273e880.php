<a href="#" rel="tooltip"
   class="btn btn-sm btn-primary btn-round btn-fab" data-toggle="modal" data-target="#modalLocation"
   rel="tooltip" data-original-titAddLocationle="" title="<?php echo e($labels['add'] ?? 'add'); ?>"
   data-placement="top" id="AddLocation">
...
<table   class="table">
    ...
    <tr class="background-color-indicator-activity">
        ...
        <th>
            <?php echo e($labels['location_na'] ?? 'location_na'); ?>

        </th>
        <th>
            <?php echo e($labels['location_fo'] ?? 'location_fo'); ?>
    ...
    <?php $__currentLoopData = $locations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index=>$location): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
            ...
            <td><?php echo e($location->location_fo); ?></td>
            <td>
                <a href="<?php echo e(route('activity.location.edit',$location->id)); ?>" rel="tooltip"
                   ...
                   data-toggle="modal" data-target="#modalLocation">
