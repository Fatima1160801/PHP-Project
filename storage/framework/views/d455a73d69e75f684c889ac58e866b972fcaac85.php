    ...
    <div class="col-md-12 col-12 mr-auto ml-auto">
        <div class="card card-wizard" data-color="rose" id="createTaskWizard">
            ...
            <div class="card-header text-center">
                <h3 class="card-title">
                    <?php echo e($labels['concept_title'] ?? 'Concept'); ?>
                ...
                <div class="tab-content">
                    <div class="tab-pane active" id="main_info">
                        <div id="task_main_info">
                            ...
                            <?php echo Form::open(['route' => 'concept.update' ,'action'=>'post' ,'id'=>'formOpportinunityCreate']); ?>

                            <?php else: ?>
                            <?php echo Form::open(['route' => 'concept.store' ,'action'=>'post' ,'id'=>'formOpportinunityCreate']); ?>
                            ...
                            <div class="col-md-12 opp-progress-approve-reject" id="fill-opp-progress-approve-reject">
                                ...
                                <h6 style="text-transform: capitalize;font-weight: bold;" class="pull-left mr-5"><?php echo e($labels['opp_status_label'] ?? 'Status'); ?> : <span style="text-transform: capitalize;font-weight:normal;color:<?php echo e($opportunity->status_color); ?>;" id="title-app-rej"><?php if($page_action=="edit"): ?> <?php echo e($opportunity->statusInfo ? ($opportunity->statusInfo->{'concept_status_'.lang_character()} ? $opportunity->statusInfo->{'concept_status_'.lang_character()} :""):""); ?><?php else: ?> <?php endif; ?></span></h6>
                               <?php if($opportunity->concept_status_id !=1): ?>
                               ...
                               <h6 style="text-transform: capitalize;font-weight: bold;" class="pull-left mr-5"><?php echo e($labels['opp_date_label'] ?? 'Date'); ?> : <span id="title-app-rej-date" style="text-transform: capitalize;font-weight: normal;color:<?php echo e($opportunity->status_color); ?>;"><?php echo e($opportunity->status_at); ?></span></h6>
                                ...
                                <div class="col-md-6 pull-right">
                                    ...
                                    <div class="pull-left col-md-8">
                                        ...
                                        <?php endif; ?>
                                        <?php if($opportunity->proposal_id !=0): ?>
                                            <a href="<?php echo e(route('proposal.proposal.edit',$opportunity->proposal_id ?? 0)); ?>" style="font-size: 12px;color: #3F51B5;" class="pull-left col-md-6" id=""><div class="ripple-container"></div><i class="material-icons">link</i>Proposal No : <?php echo e($opportunity->proposal_id ?? 0); ?></a>
                                        <?php endif; ?>
                                    </div>
                                </div>
                            ...
                            <input id="fixed_status_val" type="hidden" value="<?php if($page_action=="edit"): ?> <?php echo e($opportunity->concept_status_id ?? 1); ?><?php else: ?> 1 <?php endif; ?>" />
                            ...
                            <div class="col-md-12">
                                ...
                                <a href="<?php echo e(route('concept.concept.index')); ?>" class="btn btn-sm btn-default pull-left"
                                   id="nextProjectMain2">
            ...
            <div class="card-footer">
                ...
                <a href="<?php echo e(route('concept.concept.index')); ?>" class="btn btn-finish btn-fill btn-rose btn-wd"
            ...
            <div class="modal-content">
                <div class="card card-signup card-plain">
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo Form::open( ['route' => 'concept.note.update','action'=>'post' ,'id'=>'formEditComment']); ?>
            ...
            <div class="modal-content">
                <div class="card card-signup card-plain">
                    ...
                    <div class="modal-body">
                        ...
                        <?php echo Form::open(['route' => 'concept.approve.reject' ,'action'=>'post' ,'id'=>'formOppStatusChange']); ?>
...
<?php $__env->startSection('script'); ?>
    <script>
        $(document).ready(function () {
            ...
            var app_st='<?php echo e($opportunity->concept_status_id ?? 1); ?>';
           <?php if($page_action=="edit"): ?>
                 fillJobTitle();
                ...
                displayOppLink();
                <?php endif; ?>
                <?php if(!empty($opportunity->proposal_id)): ?>
                displayReference();
                <?php endif; ?>
        ...
        $('a[href="#log_hour"]').click(function () {
            ...
            get_fiexd_attachments (primary_id,'<?php echo e($activity_type); ?>',12,0,0);//not display full
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.status == true) {
                        ...
                        buttonControl(1);
                        var editswitch='<?php echo e(route('concept.update')); ?>';
                       ...
                       // alert(data.opp_id);
                        ...
                        $("#formOpportinunityCreate").attr("action","<?php echo e(route('concept.update')); ?>");
        ...
        function loadComments() {
            ...
            var url = '<?php echo e(route('concept.note.index')); ?>' + '/' + task_id;
            $.ajax({
                url: url,
                // dataTypes: 'json',
                data: '',
        ...
        function loadFeedBack() {
            ...
            // $("#addProposalBtn").css("display","none");
            //var form = $(this).serialize();
            var task_id = $('#object_primary_id').val();
            var url = '<?php echo e(route('concept.feedback.index')); ?>' + '/' + task_id;
            $.ajax({
                url: url,
                // dataTypes: 'json',
                data: '',
        ...
        function loadConcept() {
            ...
            if($('#object_primary_id').val() !=0 && $('#object_primary_id').val()!=null && $('#object_primary_id').val() !=""){
                get_fiexd_attachments(primary_id,'<?php echo e($activity_type); ?>',0,12,1);//display full desc
        ...
        function loadDocuments() {
           // var task_id = $('#task_link').attr('data-task-id');
            var task_id = 1;
            var url = '<?php echo e(route('concept.document.index')); ?>' + '/' + task_id;
            $.get(url, function (response) {
                $('#loader-icon-l').hide();
     ...
     /////////////////////////////////////////////////
        ...
        $(document).on('submit', '#formAddNote', function (e) {
            var co_st=$("#concept_st_val").val();
            var feed_st=$("#feed_concept_st_val").val();
            //if(co_st !=4 && feed_st !=4){
            if(co_st ==1){
            e.preventDefault();
            if (!is_valid_form($(this))) {
                return false;
        ...
        $(document).on('submit', '#formEditComment', function (e) {
            ...
            console.log("************"+donor_id_val);
            //if(co_st ==1 && feed_st ==1){
            //if(co_st !=4 && feed_st !=4){
            if((co_st ==1 && feed_st ==1) || (feed_st ==2 && donor_id_val !=0 )) {
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data.status == true) {
                        ...
                        $('#opportunityApproveConfirmModal').val(data.opp_status);
                        $('#fixed_status_val').val(data.opp_status);
                        $('#opportunityApproveConfirmModal').modal('hide');
                        if(data.opp_status==3){
                            $("#addProposalBtn").show();
                            $("#acceptBtn").hide();
        ...
        $(document).on('click', '#approveBtn', function () {
            $("#opportunityApproveConfirmModal #approved_reject_title").text("Confirm Concept");
        ...
        $(document).on('click', '#acceptBtn', function () {
            $("#opportunityApproveConfirmModal #approved_reject_title").text("Accept Concept");
            $("#opportunityApproveConfirmModal #approved_reject_type").val(3);//
            $("#opportunityApproveConfirmModal #approved_reject_opp_id").val($("#object_primary_id").val());
            //actions
        });
        $(document).on('click', '#rejectBtn', function () {
            $("#opportunityApproveConfirmModal #approved_reject_title").text("Reject Concept");
            $("#opportunityApproveConfirmModal #approved_reject_type").val(4);
            $("#opportunityApproveConfirmModal #approved_reject_opp_id").val($("#object_primary_id").val());
        });
        ...
        function buttonControl($status){
            ...
            $("#concept_st_val").val($status);
            $("#feed_concept_st_val").val($status);
           //$(".opp-progress-approve-reject").css("display","block");
        }

        function drawBar($id){
            $('#fill-opp-progress-approve-reject').fadeOut();
            var concept_id=$("#id").val();
            <?php if($page_action=="edit"): ?>
                concept_id = '<?php echo e($opportunity->id); ?>';
                    <?php endif; ?>
            var rl = '<?php echo e(url('concept/statusControl')); ?>' + '/' + $id+'/'+concept_id;
    ...
    function setPicker($id,$val) {
        ...
        $(document).on('click', '#cancelAcceptBtn', function (e) {
            ...
            swal({
                ...
                if (result == true) {
                    url = '<?php echo e(url("concept/cancel/approve/reject/")); ?>'+'/'+$('#object_primary_id').val()+"?action_type=2";
                    $.ajax({
                        url: url,
                        type: 'get',
                        beforeSend: function () {
        ...
        $(document).on('click', '#FeedBackcancelRejectBtn', function (e) {
            ...
            swal({
                ...
                if (result == true) {
                    url = '<?php echo e(url("concept/cancel/approve/reject/")); ?>'+'/'+$('#object_primary_id').val()+"?action_type=3";
                    $.ajax({
                        url: url,
                        type: 'get',
                        beforeSend: function () {
        ...
        $(document).on('click', '#cancelRejectBtn', function (e) {
            ...
            swal({
                ...
                if (result == true) {
                    url = '<?php echo e(url("concept/cancel/approve/reject/")); ?>'+'/'+$('#object_primary_id').val();
                    $.ajax({
                        url: url,
                        type: 'get',
                        beforeSend: function () {
        ...
        $(document).on('click', '#cancelApproveBtn', function (e) {
            ...
            $this = $(this);
            swal({
                text: '<?php echo e(getMessage('2.312')['text']); ?>',
                confirmButtonClass: 'btn btn-success  btn-sm',
                cancelButtonClass: 'btn btn-danger  btn-sm',
                buttonsStyling: false,
                showCancelButton: true
                ...
                if (result == true) {
                    url = '<?php echo e(url("concept/cancel/approve/reject/")); ?>'+'/'+$('#object_primary_id').val()+"?action_type=1";
                    $.ajax({
                        url: url,
                        type: 'get',
                        beforeSend: function () {
        ...
        $(document).on('click', '#btnOpportunityDeleteNote', function (e) {
            ...
            //if(co_st ==1 && feed_st ==1){
           if((co_st ==1 && feed_st ==1) || (feed_st ==2 && dtt !=0 )){
            //if(co_st !=4 && feed_st !=4){
        ...
        $(document).on('click', '#deleteApporBtn', function (e) {
            ...
            swal({
                ...
                if (result == true) {
                    // var project_id = $('#formProjectMain #id').val();
                    url = '<?php echo e(url("concept/delete/")); ?>'+'/'+$('#object_primary_id').val();
                    $.ajax({
                        url: url,
                        type: 'delete',
                        beforeSend: function () {
                        ...
                        success: function (data) {
                            if (data.status == true) {
                              //  $($this).closest('tr').css('background', 'red').delay(1000).hide(1000);
                                window.location.href = "<?php echo e(url('concept/index')); ?>";
        ...
        function enabledAllForm() {
            ...
            //
            // $("#formOpportinunityCreate #opportunity_source_id").attr("maxlength",100);
            // $("#formOpportinunityCreate #institution_role_id").attr("maxlength",100);
            // $("#formOpportinunityCreate #Opportunity").attr("maxlength",100);
        ...
        function displayReference(){
            ...
            var ref_link = '<?php echo e(route('proposal.proposal.edit',$opportunity->proposal_id ?? 0)); ?>';
            var text="رقم العرض";
            var item=   '<a href="'+ref_link+'" class="refer_link pull-right" id="nextProjectMain2">'+
                '<div class="ripple-container"></div><i class="material-icons">link</i>'+
                ''+text+'</a>';
        ...
        $(document).on('click', '#addProposalBtn', function (e) {
            var p_id = $('#object_primary_id').val();
            if(p_id ==""){
                p_id=0;
            }
            var propUrl="<?php echo e(route('proposal.proposal.create')); ?>"+"?concept_id="+p_id;
