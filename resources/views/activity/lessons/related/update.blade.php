...
@section('content')
    @include('activity.lessons.related.create_render')
{{--    <div class="card ">--}}
...
{{--            </div>--}}
{{--            <h4 class="card-title">--}}
{{--                {{$labels['edit_activity_lessons_related']??'edit_activity_lessons_related'}}--}}
{{--            </h4>--}}
{{--        </div>--}}
{{--        <div class="card-body ">--}}
...
@section('script')
    ...
    <script>
        ...
        //
        // });
function editRow(data,status,id,city,district) {
return false;
}
    </script>
@endsection
