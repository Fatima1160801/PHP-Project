...
{{--        </div>--}}
        <div class="card-body ">
            ...
            <a href="{{route('activity.lessons.type.create')}}"
               ...
               title="{{$labels["add_activity_lessons_type"]??"add_activity_lessons_type"}}">
                <i class="material-icons">add</i>
            </a>

            </span></h4>
            @include('activity.lessons.type.render_table')
...
{{--                                </a>--}}
{{--                                <button type="button" href="{{ route('activity.lessons.type.delete',$type->id )}}"--}}
...
@section('script')
    ...
    <script>
        $(function () {
            ...
            {{--    swal({--}}
            {{--        text: '{{$messageDeleteLessonsTypes['text']}}',--}}
