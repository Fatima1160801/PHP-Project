        ...
        <div class="col-md-12">
            ...
            <div class="card-footer ml-auto mr-auto">
                <div class="ml-auto mr-auto">
                    ...
                    @endif
                            @if($save==1)
                    <button type="submit" id="btnAddCurrency" class="btn btn-next btn-rose pull-right btn-sm">
                        <div class="loader pull-left" style="display: none;">

                        </div> {{$labels['save'] ?? 'save'}}
                    </button>
                        @else
                                <button type="submit" id="btnUpdateCurrency" class="btn btn-next btn-rose pull-right btn-sm">
