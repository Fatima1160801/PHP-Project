...
@section('content')
  <div class="card ">
      @include('setting.achievement.update_render')
...
{{--      {!! Form::open(['route' => ['settings.achievement.type.update',$id] ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formCreate']) !!}--}}
{{--      @if ($errors->any())--}}
...
@section('script')
  <script>
      ...
      function addRow() {
          row_id += 1;
          var html = ' <tr>';
          html += '<td style="padding: 1px"> <input required style="width: 100%;" class="form-control metric_no" type="text" name="metric_no[' + row_id + ']"></td>';
          html += '<td style="padding: 1px"><input required style="width: 100%;" class="form-control metric_fo" type="text" name="metric_fo[' + row_id + ']"></td>';
          html += '<td style="padding: 1px"><select  required class="form-control  selectpicker unit"  name="unit[' + row_id + ']"  data-style="btn btn-link" >';
      ...
      $(document).on('click', '#deleteRow', function (e) {
          ...
          if (href == '#') {
              ...
              swal({
                  text: '{{$messageDeleteAchievementMetric['text']}}',
