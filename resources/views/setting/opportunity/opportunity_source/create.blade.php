...
@section('content')
    <div class="card ">
        <div class="card-header card-header-rose  card-header-icon">
            ...
            <h4 class="card-title">
                {{$labels['addOpportunitySource'] ?? 'Add Opportunity Source'}}
            </h4>
        </div>
        <div class="card-body ">
            ...
            {!! Form::open(['route' => 'oppsources.store' ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formOpportunityCreate']) !!}
            @if ($errors->any())
            ...
            <div class="col-md-12">
                ...
                <div class="card-footer ml-auto mr-auto">
                    <div class="ml-auto mr-auto">
                        <a href="{{route('oppsources.index')}}" class="btn btn-default btn-sm">
                            {{$labels['back'] ?? 'back'}}
                        </a>
            ...
            $.ajax({
                ...
                success: function (data) {
                   ...
                   $('#btnAddOpportunity').attr("disabled", false);
                    ...
                    setTimeout(() => {
                        window.location.href = '{{route('oppsources.index')}}';
                        }, 1000);
