...
{{--        </div>--}}
        <div class="card-body ">
            ...
            <a href="{{route('units.create')}}" class="btn btn-primary btn-sm btn-round btn-fab addButtons"
               data-toggle="tooltip" data-placement="top"
               title="{{$labels['add unit'] ?? 'Add unit'}}" >
                <i class="material-icons">add</i></a>
            </span></h4>
@include('procurement.unit.table_render')
