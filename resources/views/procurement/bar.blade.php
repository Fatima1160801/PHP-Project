<nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top " id="navigation-example">
    ...
    <div class="logo" style="position: absolute;background: #eee;margin: 10px;width: 15%;">
            ...
            <ul class=" navbar-nav">
                <li class="nav-item">
                    <a class="nav-link" href="#"
                       onclick="event.preventDefault();  document.getElementById('user-change-language').submit();">
...
{{--            var url = '{{route('notifications.setViewed')}}';--}}
{{--            $.post(url);--}}
...
{{--            var url = '{{route('notifications.setRead')}}' + '/' + nid;--}}
{{--            $.get(url, function () {--}}
{{--                location.href = href;--}}
{{--            });--}}
{{--        });--}}
...
{{--            var noti_url = '{{route('notifications.list')}}';--}}
