...
@section('content')
    ...
    <div class="card ">
        ...
        <div class="card-body ">
            ...
            {!! Form::open(['route' => 'goals.indicators.store'  ,'novalidate'=>'novalidate','action'=>'post' ,'id'=>'formIndicatorCreate']) !!}
            @if ($errors->any())
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{route('goals.indicators.edit',$indicator->id)}}" rel="tooltip"
                                   ...
                                   title="{{$labels['edit_indicator']??'edit_indicator'}}"
        ...
        @section('script')
            ...
            <script>
                ...
                function cleanForm(){
                    $('#formIndicatorCreate #id').val('');
                    $('#formIndicatorCreate #indic_name_na').val('');
                    $('#formIndicatorCreate #indic_name_fo').val('');
                }
