...
class JobTitleController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('project.jobtitle.index', compact('labels','jobtitles', 'screenName','userPermissions'));
    }
    ...
    public function create()
    {
        ...
        return view('project.jobtitle.create', compact('html', 'screenName','labels','userPermissions'));
    }
    ...
    public function edit($id)
    {
       ...
       $id=['html_type'=>'10'];
        ...
        $userPermissions = getUserPermission();
        return view('project.jobtitle.edit', compact('labels','html', 'screenName', 'data','userPermissions'));
    }
